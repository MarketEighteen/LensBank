...
public class CustomerRepositoryTest {
  ...
  @InjectMocks private CustomerRepository repository;
  ...
  public void readAllShouldScanTheTable() throws Exception {
    ...
    when(dbMapper.scan(eq(Customer.class), any(DynamoDBScanExpression.class)))
  ...
  public void deleteShouldDeleteCustomerByName() throws Exception {
    ...
    verify(dbMapper)
        .delete(eq(new Customer().withName("Dale Carnegie")), any(DynamoDBMapperConfig.class));
  }
}
