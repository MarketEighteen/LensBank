...
public class CustomerServiceTest {
  ...
  public void createShouldReturnEmptyOptionalWhenCustomerAlreadyExists() throws Exception {
    ...
    Customer existingCustomer =
        new Customer().withName("Arthur C. Clarke").withAddress("Sri Lanka");
  ...
  public void replaceShouldOverwriteAndReturnNewDataWhenCustomerExists() throws Exception {
    ...
    Customer oldCustomerData =
        new Customer().withName("Arthur C. Clarke").withPhoneNumber("000000");
    Customer newCustomerData = new Customer().withName("Arthur C. Clarke").withAddress("Sri Lanka");
  ...
  @Test
  public void updateShouldOverwriteExistingFieldAndReturnNewDataWhenCustomerExists()
      throws Exception {
  ...
  @Test
  public void
      updateShouldNotOverwriteExistingFieldIfNoNewValuePassedAndShouldReturnNewDataWhenCustomerExists()
          throws Exception {
  ...
  public void deleteShouldReturnTrueWhenCustomerDeleted() throws Exception {
    ...
    when(repository.read("Arthur C. Clarke"))
        .thenReturn(Optional.of(new Customer().withName("Arthur C. Clarke")));
    boolean result = service.delete("Arthur C. Clarke");
